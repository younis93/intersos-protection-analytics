...
export interface LegalMetadata {ready:boolean;loading?:boolean;source:string|null;warnings:string[];availability:Record<string,boolean>;features?:{detention:boolean;deportation:boolean};sheets:LegalSheet[];months:string[];reviewCounts:Record<string,number>;overview?:LegalOverview}
